...
public class StudentMVCPortletAction extends MVCPortlet {
	public void addStudent(ActionRequest actionRequest,
		...
		if(student!=null){
			...
			SessionErrors.add(actionRequest.getPortletSession(),"student-add-error");
	...
	public void deleteStudent(ActionRequest actionRequest,
		...
		try {
			...
			if(student!=null){
				...
				SessionErrors.add(actionRequest.getPortletSession(),"student-delete-error");
		...
		try {
			...
			if(student!=null){
				...
				if(student!=null){
					...
					SessionErrors.add(actionRequest.getPortletSession(),"student-update-error");
					_log.error("There is an Erron in delete Student");
				}
			}else{
				SessionErrors.add(actionRequest.getPortletSession(),"student-update-error");
	...
	private static Log _log = LogFactoryUtil.getLog(StudentMVCPortletAction.class);
}
